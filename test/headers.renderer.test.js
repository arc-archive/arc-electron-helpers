...
describe('ArcHeaders tests', () => {
  ...
  describe('append()', () => {
    it('Appends an item that doesnt exists', () => {
  ...
  describe('set()', () => {
    it('Sets an item that doesnt exists', () => {
      const instance = new ArcHeaders();
  ...
  describe('delete()', () => {
    it('Ignores item that doesnt exists', () => {
  ...
  describe('values()', () => {
    ...
    it('Can iterate pover the values', () => {
      const instance = new ArcHeaders(input);
  ...
  describe('entries()', () => {
    ...
    it('Can iterate pover the entries', () => {
      const instance = new ArcHeaders(input);
  ...
  describe('Symbol.iterator', () => {
    ...
    it('Can iterate pover the object', () => {
      const instance = new ArcHeaders(input);
      const allowedKeys = ['My_Test', 'AbCd'];
      const allowedValues = ['header', 'Test'];
